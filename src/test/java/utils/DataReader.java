...
public class DataReader {
	...
	public static String TestDataFileName= System.getProperty("user.dir")+"//src//test//resources//testdata//MYOMNICELL_TESTDATA.xlsx";
...
public static void main(String[] args) {
		HashMap<String,String> TCData=getData("New User Register Test Case");
		System.out.println(TCData.get("Email"));
	}
